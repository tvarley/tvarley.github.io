...
implementations:
  - language: cpp
    ...
    githubLink: https://gitlab.com/tvarley/euler/-/blob/master/cpp/src/euler024.cpp
    performance: The "cheat" mode uses std::next_permutation to generate permutations until reaching the millionth, which is efficient for small inputs like 10 digits (O(1) effectively since 10! is manageable).
tags:
  - euler
  - problem-solving
featured: false
